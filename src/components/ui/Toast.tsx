...
export function Toast({ visible, className, ...props }: ToastProps) {
    return (
        <div
            className={cn(
                "min-h-16 mb-2 flex w-[350px] flex-col items-start rounded-md bg-white px-6 py-4 shadow-lg",
...
Toast.Icon = React.forwardRef<SVGSVGElement, ToastIconProps>(function ToastIcon(
